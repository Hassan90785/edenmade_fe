...
export default function SnackCard({orderInfo, itemSource, addRemoveAddOns, canSelected, snackOrder}) {
                        ...
                        <div className="card border-0 rounded-0 aj-drop-shadow">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text body-text-small text-accent mt-1">
                                    <span
                                        className="fw-bold">+ £{snack.price}</span> / {(snack.portion === 0 ||
                                    snack.portion === null) ? 'Portion' : `${snack.portion} Portion`}
                                </p>
                            </div>
                        </div>
                    </div>
